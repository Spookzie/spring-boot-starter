...
public class AuthorRepositoryIntegrationTests {
    ...
    public void testThatAuthorCanBeCreatedAndRecalled() {
        AuthorEntity testAuthorEntity = this.authorRepo.save(TestDataUtil.createTestAuthorEntityA()); // Creating author
                                                                                                      // (saving into
                                                                                                      // DB)

        Optional<AuthorEntity> result = this.authorRepo.findById(testAuthorEntity.getId()); // Recalling author
