...
public class BookControllerIntegrationTests {
        ...
        public void testThatCreateBookReturnsHttp201() throws Exception {
                ...
                String testBookJson = this.objectMapper.writeValueAsString(testBookDto); // Converting BookDto to JSON
                                                                                         // string

                this.mockMvc.perform(
                                MockMvcRequestBuilders.put("/books/" + testBookDto.getIsbn())
                                                .contentType(MediaType.APPLICATION_JSON) // Tells Spring to treat the
        ...
        public void testThatUpdateBookReturnsHttp200() throws Exception {
                BookEntity testBookEntity = TestDataUtil.createTestBookEntityA(null);
                BookEntity savedTestBookEntity = this.bookService.createUpdateBook(testBookEntity.getIsbn(),
                                testBookEntity);
